...
import { VerticalModalComponent, VerticalModalOptions } from './vertical.modal.component';
import { HorizonalModalComponent, HorizonalModalOptions } from './horizontal.modal.component';
...
export class ModalService {
    ...
    vertical(options: VerticalModalOptions): Observable<void> {
        const defaultConfig = {
            width: '450px',
            maxHeight: '80vh', // Altura máxima como 80% da viewport
            panelClass: 'vertical-modal-scroll', // Classe para estilização
            disableClose: true,
            ...options.config
        };
    ...
    horizontal(options: HorizonalModalOptions): Observable<void> {
        const defaultConfig = {
            width: '30rem',
            maxHeight: '80vh',
            disableClose: true,
        ...
        const dialogRef = this.dialog.open(HorizonalModalComponent, {
            ...defaultConfig,
            data: options
        });
