...
import {
  ErrorModalComponent,
  ErrorModalOptions,
} from './error/erros.modal.component';
import {
  LoadingModalOptions,
  LoadModalComponent,
} from './loading/loagin.modal.component';
...
export class ModalService {
  ...
  loading(): MatDialogRef<LoadModalComponent, any> {
    const options: LoadingModalOptions = { title: 'COMMON.LOADING' };
  ...
  custom(component: any, config?: any, data?: any): Observable<any> {
